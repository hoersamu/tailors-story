...
{
  public class GuiDialogBlockEntitySpinnwheel : GuiDialogBlockEntity
  {
    long lastRedrawMs;

    protected override double FloatyDialogPosition => 0.75;

    public GuiDialogBlockEntitySpinnwheel(string DialogTitle, InventoryBase Inventory, BlockPos BlockEntityPosition, ICoreClientAPI capi)
    ...
    private void OnInventorySlotModified(int slotid)
    {
      ...
      capi.Event.EnqueueMainThreadTask(SetupDialog, "setupSpinnwheeldlg");
    }
    ...
    void SetupDialog()
    {
      ...
      ElementBounds spinnwheelBounds = ElementBounds.Fixed(0, 0, 200, 90);
      ...
      bgBounds.WithChildren(spinnwheelBounds);
      ...
      SingleComposer = capi.Gui
          ...
          .BeginChildElements(bgBounds)
              .AddDynamicCustomDraw(spinnwheelBounds, OnBgDraw, "symbolDrawer")
